...
class WithdrawControllerTest {
    ...
    void withdraw_Success() throws Exception {
        ...
        mockMvc.perform(post("/api/withdraw")
                ...
                .andExpect(jsonPath("$.message")
                        .value("₹2000 debited successfully from your account"));
    }
    ...
    void withdraw_NegativeAmount() throws Exception {
        ...
        mockMvc.perform(post("/api/withdraw")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.message")
                        .value("Withdraw failed: Amount must be greater than 0"));
    }
    ...
    @Test
    void withdraw_MissingCustomerIdHeader() throws Exception {
